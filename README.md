# Description
An osu! Bongo Cat overlay with smooth paw movement and simple skinning ability, written in C++. Configuration file written by [KiteAB](https://github.com/KiteAB), enjoy the cat!

If you're not using [Colemak Keyboard Layout](https://colemak.com), you may want to modify some keycodes and images to achieve this. See their [wiki](https://github.com/kuroni/bongocat-osu/wiki/Settings) to know more about this configuration file.

You can find how to configure the application in their [wiki](https://github.com/kuroni/bongocat-osu/wiki/Settings).
...
If you have troubles compiling, it can be due to version mismatch between ytheir compiler and SFML. See [#43](https://github.com/kuroni/bongocat-osu/issues/43) for more information.
